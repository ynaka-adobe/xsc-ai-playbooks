...
>
> _Auto-generated from the `merge-back-to-base-template` plugin skill. Edit the skill, not this file._
...
**MANIFEST** (the artifact list at the end of each integration playbook, e.g. `add-adobe-target`).
