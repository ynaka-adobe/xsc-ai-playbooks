...
>
> _Auto-generated from the `eds-readiness` plugin skill. Edit the skill, not this file._
...
- **"I want my own reusable base template first"** → the **`create-base-template`** playbook (one-time), then
